...
const EmployeeCard = ({data}) => {
  ...
  return (
    <Card variant="cardBackground" className={card__container} sx={{borderRadius: "12px"}}>
      <Container sx={{padding: "0px", position: "relative", height: "280px", overflow: "hidden", borderRadius: "6px"}}>
      ...
      <Typography sx={{marginTop: "8px", fontWeight: {moible: 400, tablet: 500}, fontSize: {mobile: 14, tablet: 16}, lineHeight: {mobile: "20px",tablet: "25px"}}}>{data.descripcion}</Typography>
    </Card>
  )
}
