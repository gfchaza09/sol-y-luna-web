...
import fotoMenu from "../../../public/assets/images/platillo-home.jpg";
  ...
  return (
    <section className={Styles.section}>
      <div className={Styles.container}>
        <div>
          <Typography component="h2" variant={width > 768 ? "h2" : width > 480 ? "h3" : "h5"} sx={{display: {mobile: "block", tablet3: "none"}, textAlign: "center"}}>{data?.menu?.titulo}</Typography>
        </div>
        <div className={Styles.picture}>
          <Image className={Styles.img} src={fotoMenu} alt="foto-menu" />
        </div>
        <div className={Styles.text}>
          <Typography component="h2" variant="h2" sx={{display: {mobile: "none", tablet3: "block"},textAlign:"left"}}>{data?.menu?.titulo}</Typography>
      ...
      <div className={Styles.containerReverse}>
        <div>
          <Typography component="h2" variant={width > 480 ? "h3" :"h5"} sx={{display: {mobile: "block", tablet3: "none"}, textAlign: "center"}}>{data?.sobreNosotros?.titulo}</Typography>
        </div>
        <div className={Styles.picture}>
          <Image className={Styles.img} src={fotoAbout} alt="foto-menu" />
        </div>
        <div className={Styles.text}>
          <Typography component="h2" variant="h2" sx={{display: {mobile: "none", tablet3: "block"},textAlign:"left"}}>{data?.sobreNosotros?.titulo}</Typography>
